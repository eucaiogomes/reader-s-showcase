  ...
  return (
    <div className="bg-white border-b border-gray-100 sticky top-14 z-40">
      <div className="max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 py-3">
        <div className="max-w-[1240px] mx-auto bg-white border border-gray-200 rounded-3xl shadow-sm px-3 py-3">
            ...
            {categories.map(([categoryId, category]) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-3 py-2 text-sm font-semibold transition-all duration-150 whitespace-nowrap ${
                    isActive
              ...
              {categoryData.subs.map((sub: any) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full border px-3 py-1.5 text-xs font-medium transition-all duration-150 whitespace-nowrap ${
                      isActive
                        ? 'border-orange-500 bg-orange-50 text-orange-700'
