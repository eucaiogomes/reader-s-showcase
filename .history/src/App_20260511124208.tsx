  ...
  return (
    <div className="bg-white border-b border-gray-100 sticky top-14 z-40">
      <div className="max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 py-3">
        <div className="max-w-[1480px] mx-auto bg-white border border-gray-200 rounded-3xl shadow-sm px-4 py-3">
            ...
            {categories.map(([categoryId, category]) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-4 py-2 min-h-[38px] min-w-[130px] text-sm font-semibold transition-all duration-150 whitespace-nowrap ${
                    isActive
              ...
              {categoryData.subs.map((sub: any) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full border px-4 py-2 min-h-[38px] min-w-[130px] text-sm font-medium transition-all duration-150 whitespace-nowrap ${
                      isActive
                        ? 'border-orange-500 bg-orange-50 text-orange-700'
              ...
              >
                ...
                <div className="bg-[#F7F9FC] py-12 border-t border-slate-200/70">
                  <div className="max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16">
                    <div className="mb-6 text-sm text-slate-500">Use os chips acima para navegar entre categoria, subcategoria e vitrine.</div>
