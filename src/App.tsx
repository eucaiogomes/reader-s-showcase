...
const SECTIONS: Section[] = [
  ...
  { id: 'l1', title: 'Treinamentos de Liderança em Alta', variant: 'avancado-1', items: [
      { id: 'l1-0', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-0/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Liderança Situacional e Adaptabilidade', description: 'Como ajustar seu estilo de liderança para diferentes maturidades de equipe.', duration: '4h 20min', price: '' },
      { id: 'l1-1', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-1/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Comunicação Não-Violenta para Líderes', description: 'Técnicas de diálogo para resolver conflitos e dar feedbacks construtivos.', duration: '3h 15min', price: '' },
      { id: 'l1-2', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-2/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Gestão de Mudanças Organizacionais', description: 'Como conduzir times em períodos de transição com foco em resultados.', duration: '5h 00min', price: '' },
      { id: 'l1-3', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-3/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Inteligência Emocional e Tomada de Decisão', description: 'O papel das emoções no julgamento profissional e na liderança de pessoas.', duration: '2h 45min', price: '' },
      { id: 'l1-4', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-4/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Mentoria e Desenvolvimento de Talentos', description: 'Como identificar potenciais e acelerar a carreira dos seus liderados.', duration: '6h 30min', price: '' },
      { id: 'l1-5', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-5/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Liderança de Times Remotos e Híbridos', description: 'Estratégias para manter engajamento e cultura à distância.', duration: '3h 50min', price: '' },
      { id: 'l1-6', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-6/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Gestão de Conflitos e Mediação', description: 'Ferramentas práticas para lidar com atritos entre membros da equipe.', duration: '4h 10min', price: '' },
      { id: 'l1-7', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-7/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Delegação e Accountability', description: 'Como distribuir responsabilidades e garantir a entrega sem microgestão.', duration: '3h 20min', price: '' },
      { id: 'l1-8', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-8/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Cultura de Inovação para Gestores', description: 'Como criar um ambiente seguro para o erro e para o surgimento de novas ideias.', duration: '4h 45min', price: '' },
      { id: 'l1-9', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-9/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Liderança Inclusiva e Diversidade', description: 'Promovendo equidade e pertencimento nos processos de gestão.', duration: '3h 30min', price: '' },
      { id: 'l1-10', type: 'COURSE', thumb: `https://picsum.photos/seed/lider-10/400/225`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Estratégia e Visão de Negócio para Líderes', description: 'Conectando as metas do time aos objetivos globais da organização.', duration: '5h 15min', price: '' },
    ]
  },
  ...
  { id: 'o1', title: 'Treinamentos de Onboarding em Alta', variant: 'avancado-1', items: [
      { id: 'o1-0', type: 'COURSE', thumb: `https://images.unsplash.com/photo-1556742044-3c52d6e88c62?q=80&w=400&h=225&auto=format&fit=crop`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Como conduzir um onboarding com um cliente', description: 'Passo a passo para garantir que o cliente entenda o valor do produto desde o primeiro dia.', duration: '2h 30min', price: '' },
      { id: 'o1-1', type: 'COURSE', thumb: `https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=400&h=225&auto=format&fit=crop`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Boas-vindas à nossa cultura', description: 'Conheça nossos valores, missão e o que nos move como empresa.', duration: '1h 15min', price: '' },
      { id: 'o1-2', type: 'COURSE', thumb: `https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=400&h=225&auto=format&fit=crop`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Primeiros passos nas ferramentas', description: 'Um guia prático sobre as plataformas que usamos no dia a dia.', duration: '1h 45min', price: '' },
      { id: 'o1-3', type: 'COURSE', thumb: `https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?q=80&w=400&h=225&auto=format&fit=crop`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Manual de conduta e ética', description: 'Nossas diretrizes para um ambiente de trabalho saudável e profissional.', duration: '1h 00min', price: '' },
      { id: 'o1-4', type: 'COURSE', thumb: `https://images.unsplash.com/photo-1557426272-fc759fbb7a8d?q=80&w=400&h=225&auto=format&fit=crop`, authors: 'Equipe Lector', progress: 0, grade: 0, title: 'Como encantar o cliente na primeira reunião', description: 'Técnicas de comunicação e apresentação para o kick-off de projetos.', duration: '2h 00min', price: '' },
    ]
  },
